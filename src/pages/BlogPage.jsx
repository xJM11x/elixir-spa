...
const BlogPage = () => {
    ...
    return(
        <div className="px-[20px] sm:px-[30px] md:px-[60px] pb-[200px] flex flex-col items-center">
            <h1 className="font-playfair-display text-center  font-bold text-[48px] text-[#485935] pt-[143px] pb-[50px] md:pb-[84px]">Blog</h1>            
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="max-w-[464px] ml-0 md:ml-[50px] flex lg:block items-center flex-col">
                    <h1 className="font-playfair-display font-bold text-[18px] sm:text-[24px] md:text-[28px] text-[#485935] pt-[30px] pb-[22px]">CATEGORIA</h1>
