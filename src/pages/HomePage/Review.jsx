const Review = () => {
    return(
        <div className="px-[80px] w-screen max-w-full flex items-center flex-col">
            ...
            <div className="ml-[57px] text-black relative bg-[#B59E7D]/60 max-w-[540px] w-full rounded-[24px] pl-[21px] pr-[32px] mt-[65px]">
            ...
            <div className="mr-[57px] text-black relative bg-[#B59E7D]/60 max-w-[540px] w-full rounded-[24px] pl-[21px] pr-[32px] mt-[65px]">
            ...
            <div className="ml-[57px] text-black relative bg-[#B59E7D]/60 max-w-[540px] w-full rounded-[24px] pl-[21px] pr-[32px] mb-[180px] mt-[65px]">
